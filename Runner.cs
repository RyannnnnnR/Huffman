    ...
    class Runner : IRunner
    {
        ...
        public void Run(string[] args)
        {
            ...
            if (inputData.Count != decodedData.Count)
                Console.WriteLine("Input data is not identical to decoded data -- Coding method does not work accurately! 1");
            else
            {
                int i;
                for (i = 0; i < inputData.Count; i++)
                {
                    ...
                    {
                        Console.WriteLine("Input data is not identical to decoded data -- Coding method does not work accurately! 2");
                        break;
                    }
                }
